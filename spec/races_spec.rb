...
describe 'Module #3 Summative: Implement Races Collection' do
  ...
  context 'rq02' do
    ...
    it 'meters method converts miles, kilometers, meters and yards to meters or returns nil' do
      ...
      expect(Event.new(u: 'yards', d: 10_000).meters.round(1)).to eql 9144.0
    ...
    it 'miles method converts miles, kilometers, meters and yards to meters or returns nil' do
      ...
      expect(Event.new(u: 'kilometers', d: 100_000).miles.round(1)).to eql 62_137.1
      expect(Event.new(u: 'meters', d: 100_000).miles.round(2)).to eql 62.14
      expect(Event.new(u: 'yards', d: 10_000).miles.round(2)).to eql 5.68
