...
class RacersControllerTest < ActionController::TestCase
  ...
  test 'should create racer' do
    assert_difference('Racer.count') do
      post :create, racer: { birth_year: @racer.birth_year, city: @racer.city, first_name: @racer.first_name, gender: @racer.gender, last_name: @racer.last_name, state: @racer.state }
    end
  ...
  test 'should update racer' do
    patch :update, id: @racer, racer: { birth_year: @racer.birth_year, city: @racer.city, first_name: @racer.first_name, gender: @racer.gender, last_name: @racer.last_name, state: @racer.state }
    assert_redirected_to racer_path(assigns(:racer))
  end
